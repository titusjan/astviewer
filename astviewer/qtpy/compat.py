...
from astviewer.qtpy import PYQT4
from astviewer.qtpy.QtWidgets import QFileDialog
from astviewer.qtpy.py3compat import is_text_string, to_text_string, TEXT_TYPES
...
def _qfiledialog_wrapper(attr, parent=None, caption='', basedir='',
    ...
    try:
        # PyQt <v4.6 (API #1)
        from astviewer.qtpy.QtCore import QString
    except ImportError:
        # PySide or PyQt >=v4.6
